...
<div>
	<div>
	$(html"$q_1$") = $(@bind q1 Slider(-1:0.01:1; default=1, show_value=true))
	<br/>
	$(html"$q_2$") = $(@bind q2 Slider(-1:0.01:1; default=1, show_value=true))
	</div>
</div>
""")
...
<div style="display: flex">
	...
	$(html"$x_1$") = $(@bind x1 Slider(-1:0.01:1; default=0.35, show_value=true))
	<br/>
	$(html"$y_1$") = $(@bind y1 Slider(-1:0.01:1; default=0.35, show_value=true))
	</div>
	<div>
	$(html"$x_2$") = $(@bind x2 Slider(-1:0.01:1; default=-0.35, show_value=true))
	<br/>
	$(html"$y_2$") = $(@bind y2 Slider(-1:0.01:1; default=-0.35, show_value=true))
	</div>
</div>
